...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.last_modified'
        db.add_column('main_app_task', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 12, 20, 20, 2, 25, 134210), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.last_modified'
        db.delete_column('main_app_task', 'last_modified')
